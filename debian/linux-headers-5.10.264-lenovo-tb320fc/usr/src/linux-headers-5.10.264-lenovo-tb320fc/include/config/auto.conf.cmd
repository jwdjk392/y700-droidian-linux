...
ifneq "$(srctree)" "/buildd/sources"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/usr/bin/aarch64-linux-gnu- --gcc-toolchain=/usr -fintegrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
