 ...
 * Linux/arm64 5.10.264 Kernel Configuration
 *
 */
...
#define CONFIG_CMDLINE "stack_depot_disable=on kasan.stacktrace=off kvm-arm.mode=protected cgroup_disable=pressure cgroup.memory=nokmem selinux=0 droidian.lvm.prefer console=tty0"
